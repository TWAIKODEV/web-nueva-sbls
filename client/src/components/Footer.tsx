...
export default function Footer() {
  return (
    <footer className="bg-sagardoy-navy text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="text-2xl font-bold mb-4">
              ...
              <div className="text-sm font-medium text-blue-200">Business School</div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-blue-800 hover:bg-sagardoy-gold p-3 rounded-lg transition-colors duration-200">
